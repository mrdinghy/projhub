class StudiesController < ApplicationController
  ...
  private
    ...
    def study_params
      params.require(:study).permit(:name, :description, :submit_date, :problem, :current, :challenges, :interventions, :economic, :social, :environmental, :financial, :other, :recommendations)
    end
end
