class ProvincesController < ApplicationController
  ...
  def show
    @projects = Project.where('province_id = ?', @province.id)
    @tabletitle = 'All Projects for Province: ' + @province.name
  end
  ...
  private
    ...
    def province_params
      params.require(:province).permit(:name, :capital, :population, :area, :iso)
    end
end
